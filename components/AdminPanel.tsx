...
export const AdminPanel: React.FC<AdminPanelProps> = ({ 
    ...
    if (selectedCourseIndex !== null && selectedProgrammeIndex !== null) {
        ...
        return (
            <div className="p-6">
                 ...
                 <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4"><div><h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2"><Layers className="text-unikl-orange"/> DCMS: {course.code}</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{course.name} (Semester {course.semester || 1})</p></div><button onClick={() => {setIsAdding(true); setEditingIndex(null); setModuleForm({subject:'', category:'common', status:'In Progress', actual:'', finishDate:'', esim:'N', sim:'N', remark:''})}} className={btnPrimary}><Plus size={16}/> Add Task</button></div>
    ...
    if (selectedProgrammeIndex !== null) {
        ...
        return (
            <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-6"><div><h3 className="text-xl font-bold text-gray-900 dark:text-white">Courses: {prog.name}</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{prog.courses.length} Courses Listed</p></div><button onClick={() => {setIsAdding(true); setEditingIndex(null); setCourseForm({code:'', name:'', smeLead:'', semester:1, progress:{sim:0,introVideo:0,esim:0}})}} className={btnPrimary}><Plus size={16}/> Add Course</button></div>
  ...
  const renderCampusList = () => (
    <div className="p-6">
        <div className="flex justify-between items-center mb-6"><div><h3 className="text-xl font-bold text-gray-900 dark:text-white">University Campuses</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage physical campuses and their specific mode configurations.</p></div>{isSuperAdmin && <button onClick={() => {
            setIsAdding(true); 
            setEditingIndex(null); 
            ...
            <div className="mb-8 p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg animate-in fade-in slide-in-from-top-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        />
                        <p className="text-xs text-gray-400 mt-1">{editingIndex !== null ? "Cannot be changed." : "Auto-generated based on name. You can edit this manually."}</p>
                    </div>
                </div>
  ...
  const renderModesList = () => (
    <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-6"><div><h3 className="text-xl font-bold text-gray-900 dark:text-white">Modes for {data.find(c=>c.id===selectedCampusForModes)?.name}</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure active modes for this campus.</p></div><button onClick={() => {setIsAdding(true); setEditingKey(null); setModeForm({selectKey:'odl', customKey:''})}} className={btnPrimary}><Plus size={16}/> Add Mode</button></div>
    ...
    <div className="p-6">
        <div className="flex justify-between items-center mb-6">
            <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Create and manage admin accounts for the system.</p>
            </div>
            <button onClick={() => {
                setIsAdding(true); 
                setEditingIndex(null); 
            ...
            <div className="mb-8 p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg animate-in fade-in slide-in-from-top-4">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        {editingIndex === null && <p className="text-xs text-gray-400 mt-1">Default: admin123</p>}
                    </div>
                    <div>
        ...
        {modal.isOpen && (
            <div className="fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl max-w-sm w-full border border-gray-200 dark:border-gray-700 flex flex-col items-center text-center transform transition-all scale-100">
                    ...
                    <p className="mb-6 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{modal.message}</p>
